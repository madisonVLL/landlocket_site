    ...
    return (
        ...
        <table>
            <tr>
                ...
                <th className="contentDiv" style={{width:"33%", alignContent: "start"}}><h3>Web Hosting</h3><FontAwesomeIcon icon={faUserTie} className="fontIcon"/><p>From managing the domain to ensuring the site’s always online, our website hosting services ensure that customers will always be able to access your website.</p></th>
            </tr>
        </table>
    </div>
    )
